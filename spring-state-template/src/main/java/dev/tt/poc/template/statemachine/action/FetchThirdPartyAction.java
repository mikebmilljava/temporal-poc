...
@Component
public class FetchThirdPartyAction implements Action<States, Events> {

    private final ProcessActivities activities;

    @Autowired
    public FetchThirdPartyAction(ProcessActivities activities) {
    ...
    public void execute(StateContext<States, Events> context) {
        ...
        // 2) Call out to the third‐party via our service abstraction
        ...
        context.getStateMachine().sendEvent(Events.THIRD_PARTY_FETCHED);
    }
}
